...
let list = {};
	...
	list.value = givenArray[0];

	givenArray.shift();

	list.rest = (givenArray.length > 0) ? arrayToList(givenArray) : null;
...
/////////////////////////********************* listToArray ****************************///////////////////////////
 ...
 function listToArray(givenObject){

 	let inputObject = givenObject;

 	let listArray = [];

 	while (inputObject!== null){

 		listArray.push(inputObject.value);

 		inputObject = inputObject.rest

 		listToArray(inputObject);
...
return listArray;
 ...
 let madeList = arrayToList([1,2,3,5,6,6]);
 console.log(madeList);

 let madeArray = listToArray(madeList);
...
/////////////////////////********************* preprend ****************************///////////////////////////
 ...
 let prependeObj = preprend(13,madeList);
  console.log(prependeObj);
