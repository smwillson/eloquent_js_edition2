...
// to filter out objects that have a mother property
function hasKnownMother(ancestryArrayElement){
	return ancestryArrayElement.mother !== null;
}

// this array only has elements that have a known mother
...
ancestry.forEach(function(element){
	...
	//console.log( element.mother);
	let mother = byName[element.mother];

	let motherDOB = (mother) ? mother.born : 0;
	
	if(!(motherDOB === 0)){

		ageDiffArray.push(element.born - motherDOB);
